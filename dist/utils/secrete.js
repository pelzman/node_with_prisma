...
exports.APP_PORT = _.defaultTo(process.env.APP_PORT, 3000);
exports.LOG_DIRECTORY = _.defaultTo(process.env.LOG_DIRECTORY, path.resolve('logs'));
exports.JWT_SECRET = _.defaultTo(process.env.JWT_SECERET, "secret");
exports.SESSION_SECRET = _.defaultTo(process.env.SESSION_SECERET, "secret");
exports.DB = {
